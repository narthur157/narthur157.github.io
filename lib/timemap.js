 ...
 * Thanks to Jorn Clausen (https://www.oe-files.de) for initial concept and code.
 ...
 *     <li><a href="https://groups.google.com/group/timemap-development">Discussion Group</a></li>
 ...
 * <a href="https://code.google.com/p/timemap/wiki/UsingTimeMapInit">UsingTimeMapInit wiki page</a>
 * for usage.</p>
 *
 ...
 *                                                  Timeline.createBandInfo (see the <a href="https://code.google.com/p/simile-widgets/wiki/Timeline_GettingStarted">Timeline Getting Started tutorial</a>).
...
TimeMap.init({
     ...
     *                                  <a href="https://api.jquery.com/jQuery.ajax/">jQuery.ajax</a>
     *                                  may be set here
     */
    remote: function(options) {
         ...
         * <a href="https://api.jquery.com/jQuery.ajax/">jQuery.ajax</a> should be set on this
 ...
 * @constructor
 * @param {Object} [options]        A container for optional arguments
 * @param {String} [options.icon=https://www.google.com/intl/en_us/mapfiles/ms/icons/red-dot.png]
 ...
 * @param {String} [options.iconShadow=https://www.google.com/intl/en_us/mapfiles/ms/icons/msmarker.shadow.png]
 *                                                      Icon image for marker placemarks
 ...
 * @example
 TimeMap.util.nsMap['georss'] = 'https://www.georss.org/georss';
 // find georss:point
...
TimeMap.dateParsers = {
    ...
    /** 
     * Clunky fix for Chrome bug: https://code.google.com/p/chromium/issues/detail?id=46703
     * @private
     */
